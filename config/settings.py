...
class Settings(BaseSettings):
    ...
    research_model: str = Field(default="deepseek-ai/deepseek-v4-pro", env="RESEARCH_MODEL")
    topic_extraction_model: str = Field(default="deepseek-ai/deepseek-v4-pro", env="TOPIC_EXTRACTION_MODEL")
    topic_ranking_model: str = Field(default="deepseek-ai/deepseek-v4-pro", env="TOPIC_RANKING_MODEL")
    script_strategy_model: str = Field(default="deepseek-ai/deepseek-v4-pro", env="SCRIPT_STRATEGY_MODEL")
    hook_generation_model: str = Field(default="deepseek-ai/deepseek-v4-pro", env="HOOK_GENERATION_MODEL")
    outline_model: str = Field(default="deepseek-ai/deepseek-v4-pro", env="OUTLINE_MODEL")
    script_model: str = Field(default="deepseek-ai/deepseek-v4-pro", env="SCRIPT_MODEL")
    fact_check_model: str = Field(default="deepseek-ai/deepseek-v4-pro", env="FACT_CHECK_MODEL")
    script_review_model: str = Field(default="deepseek-ai/deepseek-v4-pro", env="SCRIPT_REVIEW_MODEL")
    retention_model: str = Field(default="deepseek-ai/deepseek-v4-pro", env="RETENTION_MODEL")
    scene_planner_model: str = Field(default="deepseek-ai/deepseek-v4-pro", env="SCENE_PLANNER_MODEL")
    seo_model: str = Field(default="deepseek-ai/deepseek-v4-pro", env="SEO_MODEL")
    image_prompt_model: str = Field(default="deepseek-ai/deepseek-v4-pro", env="IMAGE_PROMPT_MODEL")
